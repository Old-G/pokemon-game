...
const BoardPage = () => {
  ...
  return (
    <div className={s.root}>
      ...
      <div
        className={classNames(s.currentPlayerOne, {
          [s.active]: pokemonContext.currentPlayer === 1,
        })}
      />
      ...
      <div
        className={classNames(s.currentPlayerTwo, {
          [s.active]: pokemonContext.currentPlayer === 2,
        })}
      />
